...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function setupPCMarquee() {
        ...
        const speed = window.innerWidth <= 768 ? 120 : 320;
...
document.addEventListener('DOMContentLoaded', function initAuth() {
    ...
    if (resetForm) {
        resetForm.addEventListener('submit', async (e) => {
            ...
            try {
                ...
                resetError.textContent = translateAuthError(err.message);
            } finally {
    ...
    function translateAuthError(msg) {
        ...
        if (msg.includes('rate limit')) return '요청이 너무 많습니다. 잠시 후 다시 시도해 주세요.';
        ...
        if (msg.includes('Unable to validate')) return '입력 정보를 확인해 주세요.';
        return msg;
    }
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (heroVideo && textOverlay) {
        ...
        const sceneTimetable = [
            { start: 9.40,  end: 11.40, text: "먹팡", positionClass: "pos-B" },
            { start: 11.40, end: 13.40, text: "놀팡", positionClass: "pos-A" },
            { start: 13.40, end: 15.25, text: "쉼팡", positionClass: "pos-D" },
            { start: 15.25, end: 17.25, text: "살팡", positionClass: "pos-CD" },
            { start: 17.25, end: 19.00, text: "멋팡", positionClass: "pos-C" }
        ];
